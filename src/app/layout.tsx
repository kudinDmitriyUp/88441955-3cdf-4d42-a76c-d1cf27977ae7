...
export const metadata: Metadata = {
  ...
  description: "Discover timeless jewelry pieces crafted by master artisans. Premium diamonds, gold, and custom designs for life's precious moments.",
  keywords: "luxury jewelry, diamond rings, gold necklaces, custom jewelry, handcrafted jewelry, engagement rings, fine jewelry",
  metadataBase: new URL("https://luxejewelry.com"),
  alternates: {
    canonical: "https://luxejewelry.com"
  },
  openGraph: {
    title: "Luxe Jewelry - Exquisite Handcrafted Collection",
    description: "Discover timeless jewelry pieces crafted by master artisans. Premium diamonds, gold, and custom designs.",
    url: "https://luxejewelry.com",
    siteName: "Luxe Jewelry",
    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763252597890-1otoilep.jpg",
  ...
  twitter: {
    ...
    title: "Luxe Jewelry - Exquisite Handcrafted Collection",
    description: "Discover timeless jewelry pieces crafted by master artisans.",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32T51L3BHE8qqE8rXXWBwMZaYtk/uploaded-1763252597890-1otoilep.jpg"]
  },
  robots: {
    index: true,
    follow: true
